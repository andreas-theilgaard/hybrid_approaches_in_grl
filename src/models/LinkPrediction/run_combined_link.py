from src.models.LinkPrediction.combined.logits_integration import fit_logits_integration
from src.models.LinkPrediction.combined.combined_latents import fit_combined_latents
